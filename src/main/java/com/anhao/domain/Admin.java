...
public class Admin extends ABaseEntity {
    ...
    public String toString() {
        return "Admin{" + "username=" + username + ", password=" + password + ", email=" + email + ", name=" + name + ", department=" + department + ", isEnabled=" + enabled + ", isLocked=" + locked + ", loginFailureCount=" + loginFailureCount + ", lockedDate=" + lockedDate + ", loginDate=" + loginDate + ", loginIp=" + loginIp + '}';
    }
